...
and returns one list-of-lists with each of the corresponding
...
def add(matrix1, matrix2) -> list:
    return [[n + m for n, m in zip(l1, l2)] for l1, l2 in zip(matrix1, matrix2)]


if __name__ == "__main__":
    print(add([[1, 2], [3, 4]], [[3, 4], [4, 5]]))
...
If you've been doing Python for a little while you might spot a bit of code that we could rewrite here. We're making an new empty list,
looping over an old list, and appending to the new list each time we loop like this:
