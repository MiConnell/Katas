# https://www.pythonmorsels.com/exercises/24ce703aa77646cc881b0837d5be2391/submit/1/

"""
Problem Statement
Hey friend!

This week's exercise might seem a bit uninteresting at first because it involves working with an HTML-like syntax at a low level.
The purpose this week isn't to familiarize yourself with HTML, but to get some practice with string manipulation in Python.

This week I'd like you to write a function that accepts two strings containing opening HTML tags
and returns True if they have the same attributes with the same values.
...
Ignore order of attributes: the same attribute names/values in a different order should be equivalent
